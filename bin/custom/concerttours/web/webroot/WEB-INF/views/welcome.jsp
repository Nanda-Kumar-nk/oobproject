...
<div class="container">
    ...
    <div>
        ...
        <ul>
            ...
            <li><b>web/webroot/WEB-INF/config/concerttours-web-app-config.xml</b> - here you can define web related
                services,
                facades etc.
            </li>
            <li><b>web/webroot/WEB-INF/config/concerttours-spring-security-config.xml</b> - here you can configure your
